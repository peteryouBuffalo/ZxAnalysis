...
// Tue Aug 25 20:52:33 2020 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: root:://cmsxrootd.fnal.gov//store/mc/RunIISummer16NanoAODv6/DYToLL_0J_13TeV-amcatnloFXFX-pythia8/NANOAODSIM/PUMoriond17_Nano25Oct2019_102X_mcRun2_asymptotic_v7_ext1-v1/270000/F3D6B6BD-BE91-9F4B-B7F8-4046E69B188D.root
//////////////////////////////////////////////////////////
...
class ZxSelector : public TSelector {
public :
   ...
   TTreeReaderArray<Int_t> Photon_cutBased17Bitmap = {fReader, "Photon_cutBased17Bitmap"};
...
private:
	...
	TH1D* h_evt;			
	TH1D* h_dR_je;			// dR for electron overlap
	TH1D* h_dR_jm;			// dR for muon overlap
	TH1D* h_nMuon;			// # of muons
	TH1D* h_nElec;			// # of electrons
	TH1D* h_nJet;			// # of jets
	TH1D* h_elec_cutflow;	
	TH1D* h_muon_cutflow;
	TH1D* h_Jet_cutflow;
...
#ifdef ZxSelector_cxx
void ZxSelector::Init(TTree *tree)
{
